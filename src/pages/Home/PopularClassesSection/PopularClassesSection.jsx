...
const PopularClassesSection = () => {
    ...
    return (
        <div className={`pt-10 my-component ${theme === 'dark' ? 'dark' : ''}`}>
            {/* bg-gradient-to-r from-gray-500 via-white to-white  */}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-20'>
                    ...
                    <div className='sm:w-11/12'>
                        <div className="flex justify-start">
                            <img className="rounded-2xl object-cover overflow-hidden" src="https://images.unsplash.com/photo-1533557950217-8768f2ee7491?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80" />
                        </div>
                        <div className="-translate-y-32 transform ml-32 -mr-5 p-10 shadow-xl hover:shadow-2xl  rounded-bl-2xl border-b-8 border-[#ef476f] bg-white overflow-hidden">
